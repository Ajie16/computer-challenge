...
void  BSP_Init (void)
{
  NVIC_PriorityGroupConfig(NVIC_PriorityGroup_2);//设置中断优先级分组为组2：2位抢占优先级，2位响应优先级
	...
	Show_Str(30,30,128,16,"    参赛信息    ",16,0);	
 	Show_Str(30,50,128,16,"计算机能力挑战赛",16,0);				    	 
	Show_Str(30,70,128,16,"智能车载终端系统",16,0);				    	 
	Show_Str(30,90,128,16,"徐杰 沈祥龙 李东",16,0);	
	
	LCD_DrawRectangle(26,28,164,108);
